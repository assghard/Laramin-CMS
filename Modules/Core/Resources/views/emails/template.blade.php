                ...
                <div class="content"
                    ...
                    ">
                        <tr>
                            <th>
                                <a href="{{ env('APP_URL') }}"
                                    style="color: #fff; text-decoration: none;">{{ env('APP_NAME') }}</a>
                            </th>
                        </tr>
                    </table>
                    ...
                    <div class="footer"
                        style="font-family: 'Helvetica Neue', 'Helvetica', Helvetica, Arial, sans-serif; box-sizing: border-box; font-size: 14px; width: 100%; clear: both; color: #999; margin: 0; padding: 10px;text-align: center;">
                        {{ env('APP_NAME') }}<br />
                    </div>
                </div>
            </td>
