...
class PageDatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        \DB::table('page__pages')->insert([
            'is_homepage' => 1,
            'is_active' => 1,
            'title' => 'Laramin CMS homepage',
            'slug' => 'laramin-CMS-homepage',
            'caption' => 'CMS based on Laravel for quick create a simple website',
            'body' => 'Every website needs homepage, subpages, contact page, SEO base features, content manager. Laramin CMS solves this problem and provides basic functions for creation quick and lightweight website',
